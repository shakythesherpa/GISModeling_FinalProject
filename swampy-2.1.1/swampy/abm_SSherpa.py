...
This excercise is a suite of programs available from
allendowney.com
.
"""
...
class AntWorld(CellWorld):
    ...
    def __init__(self, canvas_size=600, cell_size=10):
        ...
        self.title('GIS Modeling and Problem Solving:Final Project')
    ...
    def setup(self):
        ...
        self.row([1,1,1])
        self.bu(text='Make Ant', command=self.make_turmite)
        self.endrow()
